    ...
    <form action="http://localhost/Finalopencourse/studentconn.php" method="post">
	    <div class="regform">
		  ...
		  <div class="innerform">
			  ...
			  <input class="btn "type="submit" form="form1"  name="Submitotp" value="Generate otp" id="myBtn">
		  </div>
		...
		span.onclick = function() {
			...
			if(OTP==randomNumber){
			   ...
			   document.getElementById("openCourseOptions").innerHTML =
								  '<option value="Cloud Computing">Cloud Computing</option><option value="construction">construction</option><option value="IOT">IOT</option><option value="Microcontroller">Microcontroller</option><option value="welding">welding</option>';
                    }		
		}
